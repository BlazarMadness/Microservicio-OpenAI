import { ChatGPTRepository } from '../repository/chatgpt.service';
...
async function main() {
  try {
    ...
    const response1 = await ChatGPTRepository.getResponse(question1);
    ...
    const response2 = await ChatGPTRepository.getResponse(question2, productContext);
